...
<body>
    ...
    <div class="breadcumbs-wrapper">
        ...
        <div class="bread-action">
            <ul class="list-inline mb-0">
                ...
                <li class="list-inline-item">
                    <a href="thankyou.html" class="active text-decoration-none">Thank You</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <section class="thankyou-wrapper">
        <div class="container-ctn">
            ...
            <div class="quick-enq-blue-bg">
                <a href="index.html" class="quick-enq Q-btn text-decoration-none">
                    <div class="btn-title">
                        <p>Home</p>
                    </div>
                </a>
                                            ...
                                            <div class="col-12">
                                                <div class="filed-btm mt-4 mb-0">
                                                    <div class="red-btn-bg">
                                                        <!-- <a href="" >Send</a> -->
                                                        <button type="submit"
                                                            class="red-btn text-decoration-none">Send</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="filed-btm">
                                                    ...
                                                    <input type="text" class="form-control" id="tid"
                                                        placeholder="AED098989" />
                                                </div>
                                            </div>
                                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="filed-btm">
                                                    <input type="text" class="form-control blue-bg" id="tid"
                                                        readonly placeholder="Status:  Status of the item" />
                                                </div>
                                            </div>
                                            <!-- <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                    <div class="filed-btm">
