...
<header class="top-header">
    <div class="container-ctn">
        <div class="row align-items-center">
            <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-7 col-sm-7 col-6">
                <ul class="list-inline mb-0 top-action">
                    @isset ($siteInformation->email)
                    ...
                    @endisset
                    @isset ($siteInformation->phone)
                        <li class="list-inline-item">
                            <a href="tel:+971999902070" class="text-decoration-none">
                                <div class="contact-action">
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
                                             viewBox="0 0 35 35" fill="none">
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-5 col-sm-5 col-6 d-flex justify-content-end">
                <ul class="list-inline mb-0 social-action">
                    @isset ($siteInformation->instagram_url)
                        <li class="list-inline-item">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->instagram_url }}"><i
                                    class="fa-brands fa-instagram"></i></a>
                        </li>
                    @endisset
                    @isset ($siteInformation->facebook_url)
                        <li class="list-inline-item">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->facebook_url }}"><i
                                    class="fa-brands fa-facebook"></i></a>
                        </li>
                    @endisset
                    @isset ($siteInformation->linkedin_url)
                        <li class="list-inline-item">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->linkedin_url }}"><i
                                    class="fa-brands fa-linkedin"></i></a>
                        </li>
                    @endisset
                    @isset ($siteInformation->twitter_url)
                        <li class="list-inline-item last">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->twitter_url }}"><i
                                    class="fa-brands fa-twitter"></i></a>
                        </li>
                    @endisset
                    @isset ($siteInformation->youtube_url)
                        <li class="list-inline-item">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->youtube_url }}"><i
                                    class="fa-brands fa-youtube"></i></a>
                        </li>
                    @endisset
                    @isset ($siteInformation->snapchat_url)
                        <li class="list-inline-item">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->snapchat_url }}"><i
                                    class="fa-brands fa-snapchat"></i></a>
                        </li>
                    @endisset
                    @isset ($siteInformation->pinterest_url)
                        <li class="list-inline-item">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->pinterest_url }}"><i
                                    class="fa-brands fa-pinterest"></i></a>
                        </li>
                    @endisset
                    @isset ($siteInformation->tiktok_url)
                        <li class="list-inline-item">
                            <a class="iconBox" target="_blank" href="{{ @$siteInformation->tiktok_url }}"><i
                ...
                <div class="container-fluid">
                    <div class="hamburg-menu-wrapper">
                        <a class="navbar-brand" href="{{ url('/') }}">
                            <img
                                src="{{ url('storage/site_information/logo/') . '/' . (isset($siteInformation->logo_webp) ? $siteInformation->logo_webp : '') }}"
                        ...
                        <div class="left-menu">
                            <button class="btn mobile-search" type="button" data-bs-toggle="offcanvas"
                                    ...
                                    src="{{ url('assets/web/images/icons/menu-search.svg') }}"
                                    class="img-fluid"></button>
                            <div class="quick-enq-blue-bg" data-bs-toggle="modal"
                        ...
                        <ul class="navbar-nav m-auto align-items-center">
                            ...
                            <li class="nav-item">
                                <div class="main-search">
                                    <input id="search" type="search" class="form-control search" name="search"
                                           placeholder="Enter your track Id">
                                    <div class="menu-search-icon" data-bs-toggle="modal"
                                         data-bs-target="#ship-track-modal">
                                    ...
                                    <button class="btn mobile-search" type="button"
                                            data-bs-toggle="offcanvas"
                                            data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"><img
                                            src="{{ url('assets/web/images/icons/menu-search.svg') }}"
                                            class="img-fluid" data-bs-toggle="modal"
                                            data-bs-target="#ship-track-modal"></button>
                                </div>
                            </li>
                        </ul>
                        <form class="d-flex">
        ...
        <div class="offcanvas offcanvas-start mobile_left_menu" tabindex="-1" id="mobileOffcanvasExample"
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link abt" href="javascript:;">About us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link ser" href="javascript:;">Services</a>
                    </li>
                    <li class="nav-item last">
                        <a class="nav-link car" href="javascript:;">Contact Us</a>
                    </li>
                </ul>
            ...
            <div class="offcanvas-body">
                <div class="main-search">
                    <input type="search" class="form-control search" name="search"
                           placeholder="Enter your track Id">
                    <div class="menu-search-icon" data-bs-toggle="modal" data-bs-target="#ship-track-modal">
                        <img src="{{ url('assets/web/images/icons/menu-search.svg') }}" class="img-fluid">
                    </div>
                </div>
            </div>
            ...
            @foreach ($sliders as $key => $slider)
                <div>
                    <div class="image-slide">
                        <img src="{{ url('storage/images/slider') . '/' . $slider->image_webp }}" alt="">
                                ...
                                @foreach ($keyfeatures as $key => $keyfeature)
                                    <li class="list-inline-item">
                                        <div class="aprch-box1 {{ @$key == 1 ? 'apx-2' : '' }}">
                                            <div class="box">
                                                ...
                                                @if (@$keyfeature->counter != '')
                                                    <div class="counter-big">
                                                        <h3 class="counter timer" data-to="100"
                                                            data-speed="2000">
                                                            {{ @$keyfeature->counter }} +
                                                        </h3>
                                            ...
                                            <div class="aprch-img">
                                                <img
                                                    src="{{ url('storage/images/keyfeature/') }}/{{ @$keyfeature->image_webp }}"
                                    ...
                                    <div class="explr">
                                        <a href="javascript:;" class="text-decoration-none"
                                           data-bs-toggle="modal" data-bs-target="#enquiry-modal"><span
                                                class="arrow-img"><img src="images/right-square-arrow.png"
                            ...
                            <li>
                                <div class="flex-wrapper">
                                    <div class="left">
                                        <div class="icon">
                                            <img
                                                src="{{ url('storage/images/whychooseus/icon') }}/{{ @$why_choose_us->icon_1 }}"
                                                alt="mangment">
                                        </div>
                                    </div>
                                    <div class="right">
                        ...
                        <li>
                            <div class="flex-wrapper">
                                <div class="left">
                                    <div class="icon">
                                        <img
                                            src="{{ url('storage/images/whychooseus/icon') }}/{{ @$why_choose_us->icon_2 }}"
                                            alt="mangment">
                                    </div>
                                </div>
                                <div class="right">
                        ...
                        <li>
                            <div class="flex-wrapper">
                                <div class="left">
                                    <div class="icon">
                                        <img
                                            src="{{ url('storage/images/whychooseus/icon') }}/{{ @$why_choose_us->icon_3 }}"
                                            alt="mangment">
                                    </div>
                                </div>
                                <div class="right">
            ...
            <div class="col-xxl-7 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 d-flex justify-content-end">
                <div class="right-wrapper" data-aos="fade-up">
                    <img src="{{ url('storage/images/whychooseus/image') }}/{{ @$why_choose_us->image }}"
                         class="img-fluid" alt="why choose us">
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="solution-box">
                                    <div class="solution-img">
                                        <img src="{{ url('storage/images/service/') }}/{{ @$service->image_webp }}"
                                             class="img-fluid" alt="solution image">
                                    </div>
                                ...
                                <div class="overlay">
                                    <div class="text">
                                        ...
                                        <div class="overlay-area">
                                            <div class="cargo-img">
                                                <img
                                                    src="{{ url('storage/images/service/') }}/{{ @$service->icon_webp }}"
                                                    class="img-fluid" alt="solution image"/>
                                            </div>
                                            @if (@$service->title != '')
                                                <a href="javascript:;" class="text-decoration-none"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col--12">
                                        <div class="filed-btm">
                                            ...
                                            <textarea class="form-control" name="message" placeholder="Say Something"
                                                      id="msg"></textarea>
                                            <div class="filed-icon">
                                    ...
                                    <div class="col-12">
                                        <div class="filed-btm mt-4 mb-0">
                                            <div
                                                class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 d-flex justify-content-end">
                ...
                <div class="footer-right-box">
                    <div class="footer-logo">
                        <a href="{{ url('/') }}" class="text-decoration-none">
                            <img
                                src="{{ url('storage/site_information/footer_logo/') . '/' . (isset($siteInformation->footer_logo_webp) ? $siteInformation->footer_logo_webp : '') }}"
                    ...
                    <ul class="list-inline mb-0 social-action">
                        ...
                        @isset ($siteInformation->instagram_url)
                            <li class="list-inline-item">
                                <a class="iconBox" target="_blank"
                                   href="{{ @$siteInformation->instagram_url }}"><i
                                        class="fa-brands fa-instagram"></i></a>
                            </li>
                        @endisset
                        @isset ($siteInformation->facebook_url)
                            <li class="list-inline-item">
                                <a class="iconBox" target="_blank"
                                   href="{{ @$siteInformation->facebook_url }}"><i
                                        class="fa-brands fa-facebook"></i></a>
                            </li>
                        @endisset
                        @isset ($siteInformation->linkedin_url)
                            <li class="list-inline-item">
                                <a class="iconBox" target="_blank"
                                   href="{{ @$siteInformation->linkedin_url }}"><i
                                        class="fa-brands fa-linkedin"></i></a>
                            </li>
                        @endisset
                        @isset ($siteInformation->twitter_url)
                            <li class="list-inline-item last">
                                <a class="iconBox" target="_blank"
                                   href="{{ @$siteInformation->twitter_url }}"><i
                                        class="fa-brands fa-twitter"></i></a>
                            </li>
                        @endisset
                        @isset ($siteInformation->youtube_url)
                            <li class="list-inline-item">
                                <a class="iconBox" target="_blank"
                                   href="{{ @$siteInformation->youtube_url }}"><i
                                        class="fa-brands fa-youtube"></i></a>
                            </li>
                        @endisset
                        @isset ($siteInformation->snapchat_url)
                            <li class="list-inline-item">
                                <a class="iconBox" target="_blank"
                                   href="{{ @$siteInformation->snapchat_url }}"><i
                                        class="fa-brands fa-snapchat"></i></a>
                            </li>
                        @endisset
                        @isset ($siteInformation->pinterest_url)
                            <li class="list-inline-item">
                                <a class="iconBox" target="_blank"
                                   href="{{ @$siteInformation->pinterest_url }}"><i
                                        class="fa-brands fa-pinterest"></i></a>
                            </li>
                        @endisset
                        @isset ($siteInformation->tiktok_url)
                        ...
                        <ul class="list-inline">
                            ...
                            <li>
                                <div class="flex-wrapper">
                                    ...
                                    <div class="right">
                                        @isset ($siteInformation->working_hours)
                            ...
                            <li>
                                <div class="flex-wrapper">
                                    ...
                                    <div class="right">
                                        ...
                                        <div class="mail-2">
                                            @isset ($siteInformation->alternate_email)
                            ...
                            <li>
                                <div class="flex-wrapper">
                                    ...
                                    <div class="right">
                                        ...
                                        <div class="call-2">
                                            @isset ($siteInformation->landline)
    ...
    <div class="container-ctn">
        <div class="row align-items-center">
            <div class="col-12">
                <div class="c-right">
                    <div class="c">
                        <p>All Rights Reserved by MK Trading</p>
                    </div>
                    <div class="brd"></div>
                    <div class="designby">
                        <p>Designed By</p>
                        <span><img src="{{ url('assets/web/images/pentacode-logo.png') }}" class="img-fluid"
                                   alt="pentacode"></span>
                    </div>
                </div>
            </div>
...
<div class="leftFixedBox">
    ...
    <div class="QuickSideRightBar QuickSideRightBarWhatsapp">
        <a href="tel:+971999902070">
            <div class="iconBox animateBox">
                <img class="img-fluid" src="{{ url('assets/web/images/icons/call.png') }}" alt=""/>
            </div>
            <div class="slideLeft">
                <span class="textRight">(+971) 545810022</span>
            </div>
        </a>
    </div>
    <div class="QuickSideRightBar QuickSideRightBarWhatsapp">
        <a href="https://wa.me/+971999902070" target="blank">
            <div class="iconBox">
                            ...
                            <form class="enq-form" id="modal-form" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="filed-btm">
                                            <label for="msg" class="form-label">Message</label>
                                            <textarea class="form-control" placeholder="Say Something" name="message"
                                                      id="modal_msg"></textarea>
                                            <div class="filed-icon">
                            ...
                            <form>
                                <div class="row">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="filed-btm">
                                            <label for="tid" class="form-label">Track Id</label>
                                            <input readonly disabled type="text" class="form-control" id="tid"/>
                                        </div>
                                    </div>
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="filed-btm">
                                            <label for="last-status">Status: </label>
                                            <input type="text"
                                                   class="form-control blue-bg"
                                                   id="last-status"
                                                   readonly
                                                   placeholder="Status of the item"/>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status) {
                        ...
                        response.data.shipments.sort((a, b) => new Date(b.created_at) - new Date(a.created_at));
                        ...
                        response.data.shipments.forEach(function (shipment, index) {
                            ...
                            let createdAtDate = new Date(shipment.created_at);
                            let options = {day: 'numeric', month: 'short', hour: '2-digit', minute: '2-digit'};
                            let formattedDate = new Intl.DateTimeFormat('en-US', options).format(createdAtDate);
                            ...
                            if (index === shipmentLength - 1) {
                                className = '';
                            } else if (index === 0 && shipment.status === 'Delivered') {
                                className = 'delived-arrow-green';
                            } else if (shipment.status === 'Not Delivered') {
                                className = 'delived-arrow';
                                msg = `<div class="status-discription"><p>${response.data.delivery_comments[0].comments || ''}</p></div>`;
                            }
                        ...
                        $("#last-status").val(response.message);
                        console.error("Record not found");
                    }
                },
                error: function (error) {
                    $("#last-status").val("Record not found");
